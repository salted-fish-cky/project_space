            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
				<form id="editPasswordForm">
					<table cellpadding=3>
						<tr>
							<td>新密码：</td>
							<td><input id="txtNewPass" type="Password" data-options="validType:'length[4,6]'" class="txt01 easyui-validatebox" required="required"/></td>
						</tr>
						<tr>
							<td>确认密码：</td>
							<td><input id="txtRePass" type="Password"  data-options="validType:'length[4,6]'" class="txt01 easyui-validatebox" required="required"/></td>
						</tr>
					</table>
				</form>
            </div>
