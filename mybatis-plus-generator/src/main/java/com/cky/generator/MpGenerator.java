...
//        dsc.setPassword("ckySaltedFish");
//        dsc.setUrl("jdbc:mysql://129.204.109.238:3306/weixin-dev?characterEncoding=utf8");
...
//         strategy.setInclude(new String[] { "users","my_friends","user_report","black_list"}); // 需要生成的表
