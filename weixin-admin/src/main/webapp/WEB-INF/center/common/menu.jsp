        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
				...
				<li class="nav-item ">
                    ...
                    <ul class="sub-menu">
						<li class="nav-item ">
                            <a id="bgmListMenu" href="<%=request.getContextPath() %>/blackList/showBlackList" class="ajaxify nav-link " id="bgmListMenu">
				...
				<li class="nav-item ">
                    ...
                    <ul class="sub-menu">
						<li class="nav-item ">
                            <a href="<%=request.getContextPath() %>/userReport/showReportList.action" class="ajaxify nav-link ">
