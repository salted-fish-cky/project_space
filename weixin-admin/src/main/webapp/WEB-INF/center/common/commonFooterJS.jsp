...
<%--<input type="hidden" id="apiServer" name="apiServer" value="http://localhost:8089"/>--%>
<%--<input type="hidden" id="bgmServer" name="bgmServer" value="http://58.45.229.238:8080/mvc"/>--%>
<input type="hidden" id="apiServer" name="apiServer" value="http://129.204.109.238:88/cky/"/>
