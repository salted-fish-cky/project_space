...
.desc {
	...
	<h1 class="page-title">仿微信后台管理系统 </h1>
	        ...
	        <div class="portlet light portlet-fit bordered">
	            <div class="portlet-title">
	                <div class="caption">
	                    ...
	                    <span class="caption-helper">App后台接口  + 仿微信后台管理</span>
	                </div>
	            </div>
	            <div class="portlet-body">
	                <div class="row">
	                    <div class="col-md-12">
	                        <div class="mt-widget-3" style="padding-top: 15px;">
	                        	<p class="desc"><font style="font-size: 16px;"><b>仿微信APP api - 技术选型：</b></font></p>
								...
								<p class="desc">6、netty 4.1.25</p>
								<p class="desc">7、文件服务器 FastDFS：1.26.2</p>
								<p class="desc">8、二维码 zxing：3.3.3</p>
	                ...
	                <div class="row" style="margin-top: 15px;">
	                    <div class="col-md-12">
	                        <div class="mt-widget-3" style="padding-top: 15px;">
	                        	<p class="desc"><font style="font-size: 16px;"><b>仿微信后台管理 - 技术选型：</b></font></p>
								...
								<p class="desc">8、前端分页组件：jqGrid</p>
	                        </div>
	                    </div>
	                </div>
