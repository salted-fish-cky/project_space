...
public class CodeMsg {
    ...
    public static CodeMsg MOBILE_IS_REGISTED = new CodeMsg(500217, "手机号已经被注册");
    public static CodeMsg REGIST_ERROR = new CodeMsg(500218, "注册失败");
    public static CodeMsg REGIST_SUCCESS = new CodeMsg(500218, "注册成功");
