...
//          return  Result.error(CodeMsg.ACCESS_LIMIT_REACHED);
            model.addAttribute("errmsg",Result.error(CodeMsg.ACCESS_LIMIT_REACHED));
            return "seckill_fail";
    }
...
//            return Result.error(CodeMsg.SECKILL_OVER);
            model.addAttribute("errmsg",Result.error(CodeMsg.SECKILL_OVER));
            return "seckill_fail";
        }
        //预减库存
...
//            return Result.error(CodeMsg.REPEATE_SECKILL);
            model.addAttribute("errmsg",Result.error(CodeMsg.REPEATE_SECKILL));
            return "seckill_fail";
        }
        //入队
...
//        return Result.success(0);//排队中
    ...
    public String seckillResult(Model model, HttpServletRequest request) {
