										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR 		
													...
													<TD>
													<s:property value="#cust.custIndustry.dictItemName" />
													</TD>
													<TD>
													...
													<TD>
														<s:if test="#parameters.select==null">
															<a href="${pageContext.request.contextPath }/CustomerAction_toEdit?custId=${cust.custId}">修改</a>
															&nbsp;&nbsp;
															<a href="${pageContext.request.contextPath }/customerServlet?method=delete&custId=${cust.custId}">删除</a>
														</s:if>
														<s:else>
