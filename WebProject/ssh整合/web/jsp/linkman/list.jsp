											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="lkmName" value="${param.lkmName}"></TD>

													<TD>客户名称：</TD>
													<input type="hidden" name="customer.custId" id="custId" value="${param['customer.custId']}"/>
													<TD><INPUT class=textbox
															   style="WIDTH: 80px" maxLength=50 name="custName" id="custName" value="${param['custName']}">
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:if test="#linkMan.lkmGender=='1'">男</s:if><s:else>女</s:else></TD>
													<TD><s:property value="#linkMan.lkmQq"/></TD>
													<TD><s:property value="#linkMan.lkmPhone"/></TD>
													
													<TD>
													<a href="${pageContext.request.contextPath }/LinkManAction_toEdit?lkmId=${linkMan.lkmId}">修改</a>
													&nbsp;&nbsp;
