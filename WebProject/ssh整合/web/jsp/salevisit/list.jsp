										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="visitTime_s" /></TD>
													<TD><s:property value="visitInterviewwee" /></TD>
													<TD><s:property value="visitAddress" /></TD>
													<TD><s:property value="visitDetail" /></TD>
													<TD><s:property value="visitNexttime_s" /></TD>
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/SaleVisitAction_toEdit?visitId=<s:property value="visitId" />">修改</a>
														&nbsp;&nbsp;
														<a href="javascript:void(0)" onclick="deleteConfirm('<s:property value="custName" />','${pageContext.request.contextPath }/CustomerAction_delete?custId=<s:property value="custId" />');" >删除</a>
													</TD>
												</TR>
												</s:iterator>
