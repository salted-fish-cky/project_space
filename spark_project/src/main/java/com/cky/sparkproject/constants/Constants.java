package com.cky.sparkproject.constants;
...
public interface Constants {
    ...
    String FIELD_CITY_INFOS = "cityInfos";


    String FIELD_PRODUCTID = "productId";
    String FIELD_CITYINFO = "cityInfo";
    String FIELD_AREA = "area";
    String FIELD_PRODUCT_NAME = "productName";
    String FIELD_PRODUCT_STATUS = "productStatus";
    String FIELD_AREA_LEVEL = "areaLevel";
    ...
    String PARAM_PAROFESSIONALS = "professionals";
    String PARAM_CITIES = "cities";
    String PARAM_SEX = "sex";
    String PARAM_KEYWORDS = "keywords";
    String PARAM_CATEGORY_IDS = "categoryIds";
    String PARAM_TARGET_PAGE_FLOW = "targetPage";
    String PARAM_PRODUCT_STATUS = "product_status";
}
