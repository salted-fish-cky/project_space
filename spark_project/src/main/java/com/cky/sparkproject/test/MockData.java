...
public class MockData {
	...
	public static void mock(JavaSparkContext sc,
		...
		StructType schema = DataTypes.createStructType(Arrays.asList(
				DataTypes.createStructField("t_date", DataTypes.StringType, true),
		...
		rowsRDD = sc.parallelize(userRows);
		...
		List<Row> productRows = new ArrayList<Row>();
		...
		rowsRDD = sc.parallelize(productRows);
	...
	public static void main(String[] args){
		...
		Dataset<Row> rows = sqlContext.sql("select * from product_info");
		for (Row row : rows.takeAsList(100)){
