...
<%--<input type="hidden" id="apiServer" name="apiServer" value="http://58.45.229.238:8081"/>--%>
<%--<input type="hidden" id="bgmServer" name="bgmServer" value="http://58.45.229.238:8080/mvc"/>--%>
<input type="hidden" id="apiServer" name="apiServer" value="http://129.204.109.238:8082"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://129.204.109.238:8081/mvc"/>
