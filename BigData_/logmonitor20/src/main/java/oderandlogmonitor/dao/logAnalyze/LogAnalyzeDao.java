package oderandlogmonitor.dao.logAnalyze;


import oderandlogmonitor.app.domain.BaseRecord;
import oderandlogmonitor.domain.LogAnalyzeJob;
import oderandlogmonitor.domain.LogAnalyzeJobDetail;
...
public class LogAnalyzeDao {
    ...
    public List<oderandlogmonitor.app.domain.BaseRecord> sumRecordValue(String startTime, String endTime) {
