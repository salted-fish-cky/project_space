...
public class PaymentInfoSpout extends BaseRichSpout {
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        props.put("zookeeper.connect", "number1:2181,number2:2181,number3:2181");
        props.put("group.id", "testGroup");
        props.put("zookeeper.session.timeout.ms", "400");
        props.put("zookeeper.sync.time.ms", "200");
        props.put("auto.commit.interval.ms", "1000");
        consumer = (ConsumerConnector) kafka.consumer.Consumer.createJavaConsumerConnector(new ConsumerConfig(props));
