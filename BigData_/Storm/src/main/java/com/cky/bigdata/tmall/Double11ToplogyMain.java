...
public class Double11ToplogyMain {
    public static void main(String[] args) throws Exception {
        ...
        builder.setSpout("readPaymentInfo", new com.cky.bigdata.tmall.PaymentInfoSpout(), 1);
        builder.setBolt("processIndex", new com.cky.bigdata.tmall.FilterMessageBlot(), 2).shuffleGrouping("readPaymentInfo");
        builder.setBolt("saveResult2Redis", new com.cky.bigdata.tmall.Save2RedisBlot(), 2).shuffleGrouping("processIndex");
